...
class SimuladorBancario:
    ...
    def __init__(self, tipoCliente):  
        ...
        clienteVIP = SimuladorBancario ("VIP")
        clientePlatino = SimuladorBancario ("Platino")
        clienteNormal = SimuladorBancario ("Normal")
        
    def cambiarTipoCliente(self, nuevoTipoCliente):
        self.tipoCliente = nuevoTipoCliente
        return "El tipo de cliente se a cambiado a= "+ nuevoTipoCliente